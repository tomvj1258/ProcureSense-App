...
const DashboardLayout = ({ children }) => {
  ...
  return (
    (<div
      className="grid min-h-screen w-full md:grid-cols-[auto_1fr] lg:grid-cols-[auto_1fr]">
      <div
        className={`hidden border-r md:block ${isSidebarOpen ? 'w-[200px]' : 'w-[60px]'} transition-all duration-300`}>
        <div className="sticky top-0 flex h-full max-h-screen flex-col gap-2">
          <div
            className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6 justify-between">
            {isSidebarOpen && (
      ...
      <div className="flex flex-col">
        <header
          className="sticky top-0 flex h-14 items-center gap-4 border-b px-4 lg:h-[60px] lg:px-6 bg-white z-10">
          <Sheet>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Avatar>
                <AvatarImage
                  src="https://api.dicebear.com/8.x/adventurer-neutral/svg?seed=Toby&backgroundColor=ecad80" />
        ...
        <main
          className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6 min-h-[80%] bg-muted/40">
